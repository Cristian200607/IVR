...
public class Op4ReciclajeDeEquipos implements Task {
    private final String numero;

    public Op4ReciclajeDeEquipos(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return Tasks.instrumented(Op4ReciclajeDeEquipos.class, numero);
    }
}
