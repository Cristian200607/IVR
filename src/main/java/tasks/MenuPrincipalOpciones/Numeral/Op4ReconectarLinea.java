package tasks.MenuPrincipalOpciones.Numeral;
...
import static userinterfaces.IVRPage.BOTON_NUMERAL_EN_GRABACION;
import static userinterfaces.IVRPage.BTN_COLGAR;
import static utils.Constantes.ATENCION_AL_CLIENTE;

public class Op4ReconectarLinea implements Task {
    private final String numero;

    public Op4ReconectarLinea(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(Op4ReconectarLinea.class, numero);
    }
}
