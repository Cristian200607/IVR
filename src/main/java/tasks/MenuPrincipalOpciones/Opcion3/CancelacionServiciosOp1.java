...
public class CancelacionServiciosOp1 implements Task {
    private final String numero;

    public CancelacionServiciosOp1(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return Tasks.instrumented(CancelacionServiciosOp1.class, numero);
    }
}
