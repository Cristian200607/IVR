...
public class Op1CancelarServiciosHogarOMovil implements Task {
    private final String numero;

    public Op1CancelarServiciosHogarOMovil(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return Tasks.instrumented(Op1CancelarServiciosHogarOMovil.class, numero);
    }
}
