...
public class PresentarReclamosOp2Op3 implements Task {
    private final String numero;

    public PresentarReclamosOp2Op3(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return Tasks.instrumented(PresentarReclamosOp2Op3.class, numero);
    }
}