...
public class CancelacionServiciosOp1Op2 implements Task {
    private final String numero;

    public CancelacionServiciosOp1Op2(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return Tasks.instrumented(CancelacionServiciosOp1Op2.class, numero);
    }
}
