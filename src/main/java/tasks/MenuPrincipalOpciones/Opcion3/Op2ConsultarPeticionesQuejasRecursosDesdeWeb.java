...
public class Op2ConsultarPeticionesQuejasRecursosDesdeWeb implements Task {
    private final String numero;

    public Op2ConsultarPeticionesQuejasRecursosDesdeWeb(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return Tasks.instrumented(Op2ConsultarPeticionesQuejasRecursosDesdeWeb.class, numero);
    }
}
