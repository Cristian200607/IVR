...
public class PresentarReclamosOp2Op2Op2 implements Task {
    private final String numero;

    public PresentarReclamosOp2Op2Op2(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return Tasks.instrumented(PresentarReclamosOp2Op2Op2.class, numero);
    }
}
