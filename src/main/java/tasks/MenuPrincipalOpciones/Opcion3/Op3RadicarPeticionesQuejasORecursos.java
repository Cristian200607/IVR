...
public class Op3RadicarPeticionesQuejasORecursos implements Task {
    private final String numero;

    public Op3RadicarPeticionesQuejasORecursos(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return Tasks.instrumented(Op3RadicarPeticionesQuejasORecursos.class, numero);
    }
}