...
public class ActivarRoamingInternacionalOp1 implements Task {
    private final String numero;

    public ActivarRoamingInternacionalOp1(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(ActivarRoamingInternacionalOp1.class, numero);
    }
}
