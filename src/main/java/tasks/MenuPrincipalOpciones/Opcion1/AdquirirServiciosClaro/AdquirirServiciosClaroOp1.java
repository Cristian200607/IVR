...
public class AdquirirServiciosClaroOp1 implements Task {
    ...
    public AdquirirServiciosClaroOp1(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(AdquirirServiciosClaroOp1.class, numero);
    }
