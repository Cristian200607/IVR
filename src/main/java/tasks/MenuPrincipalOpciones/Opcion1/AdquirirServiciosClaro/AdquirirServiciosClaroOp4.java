...
public class AdquirirServiciosClaroOp4 implements Task {
    private final String numero;

    public AdquirirServiciosClaroOp4(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(AdquirirServiciosClaroOp4.class, numero);
    }
