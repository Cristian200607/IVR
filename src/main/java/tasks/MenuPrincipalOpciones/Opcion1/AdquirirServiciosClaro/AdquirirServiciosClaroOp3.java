...
public class AdquirirServiciosClaroOp3 implements Task {
    ...
    public AdquirirServiciosClaroOp3(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(AdquirirServiciosClaroOp3.class, numero);
    }
}
