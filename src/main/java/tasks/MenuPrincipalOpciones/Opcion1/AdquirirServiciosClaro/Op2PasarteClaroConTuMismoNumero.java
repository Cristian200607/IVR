...
public class Op2PasarteClaroConTuMismoNumero implements Task {
    private final String numero;

    public Op2PasarteClaroConTuMismoNumero(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(Op2PasarteClaroConTuMismoNumero.class, numero);
    }
}
