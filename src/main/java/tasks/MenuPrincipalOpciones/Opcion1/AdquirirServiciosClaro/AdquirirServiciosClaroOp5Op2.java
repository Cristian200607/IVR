...
public class AdquirirServiciosClaroOp5Op2 implements Task {
    ...
    public AdquirirServiciosClaroOp5Op2(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(AdquirirServiciosClaroOp5Op2.class, numero);
    }
}
