...
public class Op5AdquiriServicioAsistenciaClaroOp1 implements Task {
    private final String numero;

    public Op5AdquiriServicioAsistenciaClaroOp1(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(Op5AdquiriServicioAsistenciaClaroOp1.class, numero);
    }
}
