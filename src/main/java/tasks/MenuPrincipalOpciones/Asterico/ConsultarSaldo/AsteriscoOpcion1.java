package tasks.MenuPrincipalOpciones.Asterico.ConsultarSaldo;
...
public class AsteriscoOpcion1 implements Task {
    ...
    public AsteriscoOpcion1(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(AsteriscoOpcion1.class, numero);
    }
}
