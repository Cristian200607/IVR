...
import tasks.MenuPrincipalOpciones.Asterico.ProductosFinanciados.Opcion4;
...
public class Opcion5 implements Task {
    ...
    public static Performable marcar(String numero) {
        return instrumented(Opcion5.class, numero);
    }
}
