package tasks.MenuPrincipalOpciones.Asterico.PaquetesActivos;
...
public class Opcion5Opcion2 implements Task {
    private final String numero;

    public Opcion5Opcion2(String numero) {
        this.numero = numero;
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.attemptsTo(
                WaitFor.aTime(27000),
                net.serenitybdd.screenplay.actions.Click.on(BOTON_5_EN_GRABACION)
        );
    ...
    public static Performable marcar(String numero) {
        return instrumented(Opcion5Opcion2.class, numero);
    }
}
