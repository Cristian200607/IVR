package tasks.MenuPrincipalOpciones.Asterico.Op3RecargarLineaPrepago;
...
public class RecargarLineaPrepago implements Task {
    ...
    public RecargarLineaPrepago(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(RecargarLineaPrepago.class, numero);
    }
}
