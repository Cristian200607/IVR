...
public class AsteriscoComprarPaquetes implements Task {
    private final String numero;

    public AsteriscoComprarPaquetes(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(AsteriscoComprarPaquetes.class, numero);
    }
}
