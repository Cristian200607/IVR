package tasks.MenuPrincipalOpciones.Asterico.Op1ConsultarSaldo;
...
public class  AsteriscoConsultarSaldo implements Task {
    private final String numero;

    public AsteriscoConsultarSaldo(String numero) {
        this.numero = numero;
    }
    ...
    public static Performable marcar(String numero) {
        return instrumented(AsteriscoConsultarSaldo.class, numero);
    }
}
